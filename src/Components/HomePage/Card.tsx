...
const Card = ({tour}: {tour: TourType}) => (
    <div className="card">
        ...
        <div className="card__details">
            ...
            <CardData icon={`${icons}#icon-map-pin`} data={tour?.startLocation?.description}/>
            <CardData
            ...
            />
            <CardData icon={`${icons}#icon-flag`} data={`${tour?.locations?.length} stops`}/>
            <CardData icon={`${icons}#icon-user`} data={`${tour?.maxGroupSize} people`}/>
        </div>
